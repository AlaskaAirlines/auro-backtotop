...
var styleCss$3 = i$5`:host{position:fixed;right:var(--ds-size-300, 1.5rem);bottom:var(--ds-size-300, 1.5rem)}:host([hidden]){display:none}[part=button]{box-shadow:var(--ds-elevation-300, 0px 0px 15px rgba(0, 0, 0, 0.2))}[part=button]::part(button){transition-property:opacity}[part=button]:not([iconOnly])::part(button){padding-right:11px}[auro-icon]{width:var(--ds-size-300, 1.5rem);height:var(--ds-size-300, 1.5rem)}`;
...
var tokensCss$2 = i$5`:host{--ds-auro-icon-color: var(--ds-color-icon-primary-default, $ds-color-icon-primary-default)}`;
...
class AuroBackToTop extends r {
  ...
  static register(name = "auro-backtotop") {
    AuroLibraryRuntimeUtils$2.prototype.registerComponent(name, AuroBackToTop);
  }
