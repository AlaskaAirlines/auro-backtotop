...
<pre class="language-shell"><code class="language-shell">$ npm i @aurodesignsystem/auro-backtotop</code></pre>
...
<pre class="language-js"><code class="language-js">import "@aurodesignsystem/auro-backtotop";</code></pre>
...
<pre class="language-html"><code class="language-html">&lt;script type="module" src="https://cdn.jsdelivr.net/npm/@aurodesignsystem/auro-backtotop@latest/+esm"&gt;&lt;/script&gt;</code></pre>
...
AuroBackToTop.register('custom-backtotop');</code></pre>
...
<pre class="language-html"><code class="language-html">&lt;custom-backtotop&gt;Custom back to top&lt;/custom-backtotop&gt;</code></pre>
<!-- AURO-GENERATED-CONTENT:END -->
</auro-accordion>
